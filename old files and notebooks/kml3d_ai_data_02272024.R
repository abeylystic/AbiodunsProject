...
# Export the data
write.csv(df_cl, file='kml3d_ai_data_all_vars.csv', row.names=FALSE)
...
# Export the data
write.csv(df_cl, file='kml3d_ai_data_no_gdp.csv', row.names=FALSE)
...
################################################################################
data3 <- subset(data, select = -c(All, Neig))
...
# Export the data
write.csv(df_cl, file='kml3d_ai_data_no_gdp_neig.csv', row.names=FALSE)
